...
DB.renderMpPuzzleStep = function () {
  ...
  DB.appRoot.innerHTML =
    '<div class="header"><div class="brand">Daily <span>BrainClub</span></div><div class="header-right">' + DB.homeBtn() + '<div class="streak-pill">' + step.def.emoji + ' ' + DB.t("mp.run.label") + ' ' + (mp.index + 1) + '/' + mp.puzzles.length + '</div></div></div>' +
